...
Suppose we wish to not deal with them. We can remove these entries. 

The other option is imputation. But since majority of missing values are dates, we can avoid these entries.

Also notice the few naming errors.
